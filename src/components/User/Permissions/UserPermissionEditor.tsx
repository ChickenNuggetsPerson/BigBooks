...
export default function UserPermissionEditor({ userUUID, orgUUID, cb, isOrgAdmin = false }: { userUUID: string; orgUUID: string; cb?: () => void, isOrgAdmin?: boolean }) {
    ...
    return (
        <div className="">
            <h1 className="font-semibold text-xl">User Permission Editor</h1>
            <Divider />
            ...
            {data && <div>
                ...
                <div className="flex gap-4 mb-4">
                    ...
                    {
                        isOrgAdmin && <button type="submit" className={`accent-button w-full`} onClick={remove}>Make Org Admin</button>
                    }
